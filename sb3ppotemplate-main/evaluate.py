...
def create_env(config_path: str, render_mode: str = "human"):
    ...
    def _make_env():
        ...
        log_file = os.path.join("logs", "eval_log")
...
def evaluate_episode(model, env, render: bool = True):
    ...
    while not done:
        ...
        # What's the difference between predict() and sample()? -- predict is getting best action, sample is for training
    ...
    return episode_info  # Placeholder
...
def main():
    ...
    parser.add_argument("--config", type=str, default="setup/track_config.yaml", help="Config file path")
    ...
    config_path = "setup/track_config.yaml"  # TODO: Get from args
